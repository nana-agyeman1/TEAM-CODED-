...
def addvote1():
    ...
    countVote1 += 1
    print (" 1 final result = ", countVote1)
...
def addvote2():
    ...
    countVote2 += 1
    print (" 2 final result = ", countVote2)
...
def addvote3():
    ...
    countVote3 += 1
    print ( " 3 final result = ", countVote3)
...
l4 = Label(app, text="CANDIDATE : {} ".format(addvote1()))
l5 = Label(app, text="CANDIDATE : {} ".format(addvote2()))
l6 = Label(app, text="CANDIDATE : {} ".format(addvote3()))
